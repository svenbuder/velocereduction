...
def lc_peak_gauss_with_offset(pixels, center, sigma, amplitude, offset):
    """
...
def lc_peak_gauss(pixels, center, sigma, amplitude):
    """
    Gaussian profile for the laser comb peak.
    ...
    Returns:
        ...
        pixel values.
    """
    return amplitude * np.exp(-0.5 * ((pixels - center) / sigma) ** 2)
